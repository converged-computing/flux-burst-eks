...
def get_parser():
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Don't do a connected burst, but mock to create a remote cluster only.",
    )
...
def main():
    ...
    # These are checked in the flux-burst kubernetes module, but only for non mock.
    ...
    client = FluxBurst(mock=args.mock)
